...
namespace AasxServerDB.Migrations.Postgres
{
    ...
    [Migration("20241023040826_ModelJsonBUpdated")]
    partial class ModelJsonBUpdated
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("AasxServerDB.Entities.JAssetAdministrationShell", "AssetAdministrationShell", b1 =>
                        {
                            ...
                            b1.OwnsOne("AasxServerDB.Entities.JAdministrativeInformation", "Administration", b2 =>
                                {
                                    ...
                                    b2.OwnsOne("AasxServerDB.Entities.JReference", "Creator", b3 =>
                                        {
                                            b3.Property<int>("JAdministrativeInformationJAssetAdministrationShellAASSetId")
                                                .HasColumnType("integer");

                                            b3.Property<int>("Type")
                                                .HasColumnType("integer");

                                            b3.HasKey("JAdministrativeInformationJAssetAdministrationShellAASSetId");

                                            b3.ToTable("AASSets");

                                            b3.WithOwner()
                                                .HasForeignKey("JAdministrativeInformationJAssetAdministrationShellAASSetId");

                                            b3.OwnsMany("AasxServerDB.Entities.JKey", "Keys", b4 =>
                                                {
                                                    b4.Property<int>("JReferenceJAdministrativeInformationJAssetAdministrationShellAASSetId")
                                                        .HasColumnType("integer")
                                                        .HasColumnName("JReferenceJAdministrativeInformationJAssetAdministrationShellA~");
                                                    ...
                                                    b4.HasKey("JReferenceJAdministrativeInformationJAssetAdministrationShellAASSetId", "Id");

                                                    b4.ToTable("AASSets");

                                                    b4.WithOwner()
                                                        .HasForeignKey("JReferenceJAdministrativeInformationJAssetAdministrationShellAASSetId");
                                                });

                                            b3.Navigation("Keys");
                                        });

                                    b2.Navigation("Creator");
                                });
                            ...
                            b1.OwnsMany("AasxServerDB.Entities.JReference", "Submodels", b2 =>
                                {
                                    b2.Property<int>("JAssetAdministrationShellAASSetId")
                                        .HasColumnType("integer");
                                    ...
                                    b2.OwnsMany("AasxServerDB.Entities.JKey", "Keys", b3 =>
                                        {
                                            ...
                                            b3.HasKey("JReferenceJAssetAdministrationShellAASSetId", "JReferenceId", "Id");

                                            b3.ToTable("AASSets");

                                            b3.WithOwner()
                                                .HasForeignKey("JReferenceJAssetAdministrationShellAASSetId", "JReferenceId");
                                        });
            ...
            modelBuilder.Entity("AasxServerDB.Entities.SMESet", b =>
                {
                    ...
                    b.OwnsOne("object", "SubmodelElement", b1 =>
                        {
                            b1.Property<int>("SMESetId")
                                .HasColumnType("integer");
                            ...
                            b1.ToJson("SubmodelElement");

                            b1.WithOwner()
                                .HasForeignKey("SMESetId");
                        });
                    ...
                    b.OwnsOne("AasxServerDB.Entities.JSubmodel", "Submodel", b1 =>
                        {
                            ...
                            b1.Property<string>("SubmodelElements")
                                .IsRequired()
                                .HasColumnType("text");
                            ...
                            b1.OwnsOne("AasxServerDB.Entities.JAdministrativeInformation", "Administration", b2 =>
                                {
                                    ...
                                    b2.OwnsOne("AasxServerDB.Entities.JReference", "Creator", b3 =>
                                        {
                                            b3.Property<int>("JAdministrativeInformationJSubmodelSMSetId")
                                                .HasColumnType("integer");

                                            b3.Property<int>("Type")
                                                .HasColumnType("integer");

                                            b3.HasKey("JAdministrativeInformationJSubmodelSMSetId");

                                            b3.ToTable("SMSets");

                                            b3.WithOwner()
                                                .HasForeignKey("JAdministrativeInformationJSubmodelSMSetId");

                                            b3.OwnsMany("AasxServerDB.Entities.JKey", "Keys", b4 =>
                                                {
                                                    b4.Property<int>("JReferenceJAdministrativeInformationJSubmodelSMSetId")
                                                        .HasColumnType("integer");
                                                    ...
                                                    b4.HasKey("JReferenceJAdministrativeInformationJSubmodelSMSetId", "Id");

                                                    b4.ToTable("SMSets");

                                                    b4.WithOwner()
                                                        .HasForeignKey("JReferenceJAdministrativeInformationJSubmodelSMSetId");
                                                });
