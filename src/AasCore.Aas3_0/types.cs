...
namespace AasCore.Aas3_0
{
    ...
    public interface IReferable : IHasExtensions
    {
        ...
        [ JsonIgnore ] public IClass? Parent { get; set; }
    ...
    public enum ModellingKind
    {
        ...
        /// </summary>
        [ EnumMember(Value = "Instance") ] Instance
    }
    ...
    public enum AasSubmodelElements
    {
        ...
        [ EnumMember(Value = "DataElement") ] DataElement,

        [ EnumMember(Value = "Entity") ] Entity,

        [ EnumMember(Value = "EventElement") ] EventElement,
    ...
    public class Reference : IReference, IEquatable<Reference>
    {
        ...
        public bool Equals(Reference? other)
        {
            ...
            return Type == other.Type &&
                   Equals(ReferredSemanticId, other.ReferredSemanticId) &&
                   Keys.SequenceEqual(other.Keys); // Assuming IKey implements correct equality
        }

        public override int GetHashCode()
        {
            // Calculate hash code based on Type, ReferredSemanticId, and Keys
            unchecked
            {
                int hashCode = (int) Type;
                hashCode = (hashCode * 397) ^ (ReferredSemanticId != null ? ReferredSemanticId.GetHashCode() : 0);
    ...
    public enum KeyTypes
    {
        ...
        [ EnumMember(Value = "Referable") ] Referable,
        ...
        [ EnumMember(Value = "Submodel") ] Submodel,
    ...
    {
        [ EnumMember(Value = "xs:anyURI") ] AnyUri,

        [ EnumMember(Value = "xs:base64Binary") ]
        Base64Binary,

        [ EnumMember(Value = "xs:boolean") ] Boolean,

        [ EnumMember(Value = "xs:byte") ] Byte,

        [ EnumMember(Value = "xs:date") ] Date,

        [ EnumMember(Value = "xs:dateTime") ] DateTime,

        [ EnumMember(Value = "xs:decimal") ] Decimal,

        [ EnumMember(Value = "xs:double") ] Double,

        [ EnumMember(Value = "xs:duration") ] Duration,

        [ EnumMember(Value = "xs:float") ] Float,

        [ EnumMember(Value = "xs:gDay") ] GDay,

        [ EnumMember(Value = "xs:gMonth") ] GMonth,

        [ EnumMember(Value = "xs:gMonthDay") ] GMonthDay,

        [ EnumMember(Value = "xs:gYear") ] GYear,

        [ EnumMember(Value = "xs:gYearMonth") ]
        GYearMonth,

        [ EnumMember(Value = "xs:hexBinary") ] HexBinary,

        [ EnumMember(Value = "xs:int") ] Int,

        [ EnumMember(Value = "xs:integer") ] Integer,

        [ EnumMember(Value = "xs:long") ] Long,
        ...
        [ EnumMember(Value = "xs:short") ] Short,

        [ EnumMember(Value = "xs:string") ] String,

        [ EnumMember(Value = "xs:time") ] Time,
    ...
    public enum DataTypeIec61360
    {
        ...
        /// comes with a physical unit.
        /// </summary>
        [ EnumMember(Value = "REAL_MEASURE") ] RealMeasure,
        ...
        /// </summary>
        [ EnumMember(Value = "REAL_COUNT") ] RealCount,
        ...
        /// </para>
        /// </remarks>
        [ EnumMember(Value = "IRDI") ] Irdi,

        /// <summary>
        /// values containing values of type rational
        /// </summary>
        [ EnumMember(Value = "RATIONAL") ] Rational,
        ...
        /// </remarks>
        [ EnumMember(Value = "TIMESTAMP") ] Timestamp,
